...
### Only women
ukhls.df <- ukhls.df[which(ukhls.df$female == 0), ]
...
save(out.fect3, file = "MC_est2_men.RData")
...
### Save
save(res.df, file = "Case_study_event_2_men.RData")
save(sum.df, file = "Case_study_simple_2_men.RData")
...
png(filename = "Case_Femaleincome_men_att.png",
...
png(filename = "Case_Femaleincome_men_avg.png",
...
png(filename = "Case_Femaleincome_men_comb.png",
