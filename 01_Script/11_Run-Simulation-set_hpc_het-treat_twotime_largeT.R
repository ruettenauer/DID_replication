...
save(test0, file = "Hettreat_twotime_largeT_Sim0.RData")
...
save(test1, file = "Hettreat_twotime_largeT_Sim1.RData")
...
save(test8, file = "Hettreat_twotime_largeT_Sim8.RData")
...
test9 <- sim_did(
  ...
  b.nonparallel = c(0.00), # Extra trend for treated (vs. non-treated) # ADD Extra trend for early treated vs late?
  beta = 1, # Treatment effect (and its distribution)
  beta.t = seq(from = 0.05, to = 0.5, length.out = 50), # Temporal distribution of treatment effect
  beta.late = 0.5, # early vs late with heterogeneous ATT, factor for late (early will have 1/beta.late), 
  size.late = 0.5, # share of late treatment group in case of beta.late 
  crs = ncores, #Parallel cores
)

save(test9, file = "Hettreat_twotime_largeT_Sim9.RData")
...
save(test9a, file = "Hettreat_twotime_largeT_Sim9a.RData")
...
save(test10, file = "Hettreat_twotime_largeT_Sim10.RData")
...
save(test12, file = "Hettreat_twotime_largeT_Sim12.RData")
...
save(test13, file = "Hettreat_twotime_largeT_Sim13.RData")
...
save(test14, file = "Hettreat_twotime_largeT_Sim14.RData")
