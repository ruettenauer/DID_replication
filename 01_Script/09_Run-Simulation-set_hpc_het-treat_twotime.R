...
save(test0, file = "Hettreat_twotime_Sim0.RData")
...
save(test1, file = "Hettreat_twotime_Sim1.RData")
...
save(test8, file = "Hettreat_twotime_Sim8.RData")
...
save(test9, file = "Hettreat_twotime_Sim9.RData")
...
### Test 9 - normal TWFE with trend-breaking treatment effect but without the group=specific heterogeneity
...
save(test9a, file = "Hettreat_twotime_Sim9a.RData")
...
save(test10, file = "Hettreat_twotime_Sim10.RData")
...
save(test12, file = "Hettreat_twotime_Sim12.RData")
...
save(test13, file = "Hettreat_twotime_Sim13.RData")
...
save(test14, file = "Hettreat_twotime_Sim14.RData")
