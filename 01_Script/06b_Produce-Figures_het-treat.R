...
png(filename = "../03_Output/Hettreat_Test0.png",
...
png(filename = "../03_Output/Hettreat_Test0_att.png",
...
### Test 0 - normal TWFE with homogeneous treatment effect and group heterogeneity



load("Hettreat_Sim0b.RData")


# Event plot
test0b.pl <- sim_plot2(test0b, xlim = c(-3, 8), ylim = c(-0.1, 0.6),
                      models = c("Conventional TWFE",  
                                 "Matrix Completion",    
                                 "Callaway SantAnna",   
                                 "Sun Abraham",    
...
# tr.pl <- ggplot(data = test0b$tr_plot[[2]],
#                 aes(x=t, y=Treatx)) +
#   geom_count() +
#   geom_smooth()
# tr.pl
...
png(filename = "../03_Output/Hettreat_test0b.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test0b.pl
dev.off()
...
# att plot
test0b.pl.att <- sim_plot_att2(test0b,
                              use.rmse = FALSE,
                              use.ci = FALSE,
                              violin = TRUE,
                              xlim = c(-0.1, 0.1),
...
png(filename = "../03_Output/Hettreat_test0b_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test0b.pl.att
dev.off()
...
zp <- grid.arrange(test0b.pl, test0b.pl.att,
                   ncol = 2, nrow = 1, 
                   layout_matrix = rbind(c(1,1,1,1,1,1, 2,2,2,2)))
zp


png(filename = "../03_Output/Hettreat_group-specific_combined.png",
...
png(filename = "../03_Output/Hettreat_1.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_1_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_8.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_8_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_9.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_9_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_10.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_10_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_12.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_12_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl.att
dev.off()
...
# Combine 
test1.pl.att.feis <- test1.pl.att.feis + ggtitle("4) Inverted U-shape") +
...
png(filename = "../03_Output/Hettreat_FEIS_combined.png",
...
png(filename = "../03_Output/Hettreat_13.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_13_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_9a.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_9a_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl.att
dev.off()
...
att.df <- rbind(att.df, data.frame(test1.pl.att$data, facet = "4) Inverted U-shape")) 
...
dist.df <- rbind(dist.df, data.frame(test1.pl.att$layers[[1]]$data, facet = "4) Inverted U-shape")) 
...
png(filename = "../03_Output/Hettreat_ATT_combined.png",
...
att.df$fade <- 0
oo <- which(att.df$facet %in% c("4) Inverted U-shape", 
                                "5) Anticipation", 
                                "6) Non-parallel trends"))
att.df$fade[oo] <- 1

dist.df$fade <- 0
oo <- which(dist.df$facet %in% c("4) Inverted U-shape", 
                                 "5) Anticipation", 
                                 "6) Non-parallel trends"))
dist.df$fade[oo] <- 1
...
att.df$estimate[att.df$fade == 1] <- NA
dist.df$dispersion[dist.df$fade == 1] <- NA
...
png(filename = "../03_Output/Hettreat_ATT_combined_00.png",
    width = 12, height = 8, units = "in", res = 300,
    type = "cairo")
zp
dev.off()
