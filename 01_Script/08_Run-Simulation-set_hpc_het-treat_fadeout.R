...
test1 <- sim_did(
  ...
  beta.t = c(0.3, 0.25, 0.2, 0.15, 0.1), # Temporal distribution of treatment effect
...
save(test1, file = "Hettreat_fadeout_Sim1.RData")
...
save(test8, file = "Hettreat_fadeout_Sim8.RData")
...
save(test9, file = "Hettreat_fadeout_Sim9.RData")
...
save(test9a, file = "Hettreat_fadeout_Sim9a.RData")
...
save(test10, file = "Hettreat_fadeout_Sim10.RData")
...
save(test12, file = "Hettreat_fadeout_Sim12.RData")
...
save(test13, file = "Hettreat_fadeout_Sim13.RData")
...
save(test14, file = "Hettreat_fadeout_Sim14.RData")
