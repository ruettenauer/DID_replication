...
load("Hettreat_largeT_Sim0.RData")
...
png(filename = "../03_Output/Hettreat_largeT_Test0.png",
...
png(filename = "../03_Output/Hettreat_largeT_Test0_att.png",
...
load("Hettreat_largeT_Sim1.RData")
...
png(filename = "../03_Output/Hettreat_largeT_1.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_1_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl.att
dev.off()
...
load("Hettreat_largeT_Sim8.RData")
...
png(filename = "../03_Output/Hettreat_largeT_8.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_8_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl.att
dev.off()
...
load("Hettreat_largeT_Sim9.RData")
...
png(filename = "../03_Output/Hettreat_largeT_9.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_9_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl.att
dev.off()
...
load("Hettreat_largeT_Sim10.RData")
...
png(filename = "../03_Output/Hettreat_largeT_10.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_10_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl.att
dev.off()
...
load("Hettreat_largeT_Sim12.RData")
...
png(filename = "../03_Output/Hettreat_largeT_12.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_12_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_FEIS_combined.png",
...
load("Hettreat_largeT_Sim13.RData")
...
png(filename = "../03_Output/Hettreat_largeT_13.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_13_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl.att
dev.off()
...
load("Hettreat_largeT_Sim9a.RData")
test9a <- test9
...
png(filename = "../03_Output/Hettreat_largeT_9a.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_9a_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_largeT_ATT_combined.png",
