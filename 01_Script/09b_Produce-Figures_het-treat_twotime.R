...
png(filename = "../03_Output/Hettreat_twotime_Test0.png",
...
png(filename = "../03_Output/Hettreat_twotime_0_att.png",
...
load("Hettreat_twotime_Sim1.RData")
...
png(filename = "../03_Output/Hettreat_twotime_1.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_1_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test1.pl.att
dev.off()
...
load("Hettreat_twotime_Sim8.RData")
...
png(filename = "../03_Output/Hettreat_twotime_8.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_8_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test8.pl.att
dev.off()
...
load("Hettreat_twotime_Sim9.RData")
...
png(filename = "../03_Output/Hettreat_twotime_9.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_9_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9.pl.att
dev.off()
...
load("Hettreat_twotime_Sim10.RData")
...
png(filename = "../03_Output/Hettreat_twotime_10.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_10_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test10.pl.att
dev.off()
...
load("Hettreat_twotime_Sim12.RData")
...
png(filename = "../03_Output/Hettreat_twotime_12.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_12_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test12.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_FEIS_combined.png",
...
load("Hettreat_twotime_Sim13.RData")
...
png(filename = "../03_Output/Hettreat_twotime_13.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_13_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test13.pl.att
dev.off()
...
load("Hettreat_twotime_Sim9a.RData")
...
png(filename = "../03_Output/Hettreat_twotime_9a.png",
    width = 14, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_9a_att.png",
    width = 8, height = 8, units = "in", res = 300,
    type = "cairo")
test9a.pl.att
dev.off()
...
png(filename = "../03_Output/Hettreat_twotime_ATT_combined.png",
